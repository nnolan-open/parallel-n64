...
static void setup_control_variables(void)
{
   struct retro_variable variables[] = {
      { "parallel-n64-alt-map",
        "Independent C-button Controls; enabled|enabled" },
      { NULL, NULL },
   };
...
static void inputGetKeys_default_descriptor(void)
{
   ...
   #define digital_cbuttons_map(PAD) \
      ...
      #define standard_map(PAD) \
         { PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_B,     "A Button (C-Down)" },\
         { PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_Y,     "B Button (C-Left)" },\
         { PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_L2,    "C Buttons Mode" },\
         { PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_START, "Start" },\
         ...
         { PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R2,    "Z-Trigger" },\
